...
public class GetReadyActivity extends BaseActivity2 implements PermissionsFragment.Client {

    private static final TLog log = TLog.get(GetReadyActivity.class);
    String email="",claimCode="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle=getIntent().getExtras();
         ...
         claimCode=bundle.getString("claim_code");
    ...
    protected void onStart() {
        ...
        softAPConfigRemover.removeAllSoftApConfigs();
        softAPConfigRemover.reenableWifiNetworks();
        Toast.makeText(getApplicationContext(), claimCode, Toast.LENGTH_SHORT).show();

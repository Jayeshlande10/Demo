...
public class ParticleDeviceSetupLibrary {
     ...
     */
    public static void startDeviceSetup(Context ctx,String claimCode,String userid) {
        Intent myIntent =new Intent(ctx,GetReadyActivity.class);

      //  myIntent.putExtra("access_token", access_token);
        myIntent.putExtra("claim_code", claimCode);
